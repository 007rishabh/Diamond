...
export default function Admin() {
  ...
  return (
    ...
    <TouchableOpacity onPress={()=>navigation.navigate('AdminShowProduct')} style={{display:'flex',flexDirection:'row',height:40,backgroundColor:'#B3C8CF',borderRadius:5,marginLeft:5}} >
    <FontAwesome name="eye" size={24} color="black" style={{marginLeft:5,marginTop:5}}/>
