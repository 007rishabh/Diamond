...
const ShowProducts = ({ route }) => {
  ...
  return (
    <View style={{ marginTop: 20 }}>
      ...
      <View
        style={{ alignItems: "center", marginTop: 50, flexDirection: "row" }}
      >
        <View style={{ width: "50%" }}>
          <FontAwesome
            name="diamond"
      ...
      <TouchableOpacity style={[styles.submitBtn, styles.green]}>
        <Text style={{ marginLeft: 160, fontSize: 20 }}>Buy</Text>
      </TouchableOpacity>
      <TouchableOpacity style={[styles.submitBtn, styles.red]}>
